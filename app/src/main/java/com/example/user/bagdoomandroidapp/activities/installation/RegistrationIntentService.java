...
public class RegistrationIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            sharedPreferences.edit().putBoolean(ApplicationConstants.SENT_TOKEN_TO_SERVER, true).apply();
            ...
            sharedPreferences.edit().putBoolean(ApplicationConstants.SENT_TOKEN_TO_SERVER, false).apply();
        }
